...
public class DefNameCaser {

    private DefNameCaser that = this;
    ...
    public DefNameCaser setWorkingWord(String workingWord) {
    ...
    public DefNameCaser setGender(int gender) {
        this.gender = gender;
        return this;
    }

    public DefNameCaser(String surname, String firstname, String middlename, Boolean isMan) {
    ...
    public DefNameCaser(String surname, String firstname, String middlename) {
        this.words.add(new Word(surname)
                .setType(Word.TYPE_SURNAME)
        );
        this.words.add(new Word(firstname)
     ...
     */
    public DefNameCaser(String nameParts) {
    ...
    private DefNameCaser detectSex(Word word) {
     ...
     */
    protected DefNameCaser genderByFatherName(Word word) {
     ...
     * @param word об’єкт класу зі словом, для якого необхідно визначити стать
     */
    protected DefNameCaser genderBySurName(Word word) {
        this.setWorkingWord(word.getWord());
     ...
     * @param word об’єкт класу зі словом, для якого необхідно визначити стать
     */
    protected DefNameCaser genderByFirstName(Word word) {
        this.setWorkingWord(word.getWord());
     ...
     */
    protected DefNameCaser detectWordType(Word word) {
     ...
     */
    protected DefNameCaser wordCases() {
     ...
     */
    private DefNameCaser wordCase(Word word) {
        this.setWorkingWord(word.getWord());
...
//        DefNameCaser defNameCaser = new DefNameCaser("Іван Іванович");
        DefNameCaser defNameCaser = new DefNameCaser("Иванов Иван Иванович");
        defNameCaser.getCaseList().forEach(System.out::println);
        System.out.println(defNameCaser.getCaseList(DefNameCaser.UAZNAHIDNYI));
    }
}